...
public class MysqlCreateTables
{
    public MysqlCreateTables()
    {
        ...
        try
        {
            ...
            stmt.execute(
                    "CREATE TABLE `bungee` ( `id` INT(11) NOT NULL AUTO_INCREMENT, `type` VARCHAR(30) NOT NULL, `value` VARCHAR(30000) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=latin1;");
            stmt.execute(
                    "CREATE TABLE `bans` ( `id` INT NOT NULL AUTO_INCREMENT, `banned` VARCHAR(36), `banned_by` INT, `reason` VARCHAR(500), `banned_when` DATETIME, `ban_expires` DATETIME, `type` BIT(1) NULL, `ban_state` INT, PRIMARY KEY (`id`));");
            stmt.execute(
