...
public class PlayerSpecInventory extends BasicInventory {
    private ItemStack _offhand = new ItemBuilder(Material.LIGHT_BLUE_STAINED_GLASS_PANE, 1).setTitle(C.Aqua + "Offhand slot")
            .build();
    ...
    private void buildPage() {
        ...
        for (EquipmentSlot slot : EquipmentSlot.values()) {
            ...
            if (item == null || item.getType() == Material.AIR) {
                ...
                item = new ItemBuilder(Material.GLASS_PANE, 1, (short) 3).setTitle(
