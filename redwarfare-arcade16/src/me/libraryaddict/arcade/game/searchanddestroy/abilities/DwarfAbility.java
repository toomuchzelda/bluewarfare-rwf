...
public class DwarfAbility extends Ability {
    private HashMap<Enchantment, Integer> _levelEvery = new HashMap<>();
    private HashMap<Enchantment, Integer> _maxLevel = new HashMap<>();

    public DwarfAbility() {
        _maxLevel.put(Enchantment.DAMAGE_ALL, 3);
