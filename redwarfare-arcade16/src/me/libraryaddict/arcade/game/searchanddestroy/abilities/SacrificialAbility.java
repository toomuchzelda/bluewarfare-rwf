...
public class SacrificialAbility extends Ability {
    ...
    public void onDamage(CustomDamageEvent event) {
        ...
        UtilParticle.playParticle(Particle.BLOCK_CRACK, Material.EMERALD_BLOCK.createBlockData(),
                dmgd.getLocation().add(0, 1, 0), 0.4, 0.4, 0.4, 0, 7, ViewDist.NORMAL);
        UtilParticle.playParticle(Particle.BLOCK_CRACK, Material.LAPIS_BLOCK.createBlockData(), sac.getLocation().add(0, 1, 0),
                0.4, 0.4, 0.4, 0, 7, ViewDist.NORMAL);
        ...
        if (UtilLoc.getDistance(dmgd, sac) > 1) {
            ...
            for (Location loc : UtilShapes.drawLineDistanced(loc1, loc2, 0.4D)) {
                ...
                UtilParticle.playParticle(loc, ParticleColor.RED, ViewDist.SHORT);
            }
        }
    ...
    public void onEntityInteract(PlayerInteractEntityEvent event) {
        ...
        if (!UtilInv.isHolding(player, event.getHand(), Material.INK_SAC))
            return;
