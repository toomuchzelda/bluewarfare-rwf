...
public class KitTrooper extends SnDKit {
    ...
    public KitTrooper() {
        super("Trooper", new String[]
                {
                        "The kit that sets the standards for all others. It receives a set of iron armor and an iron sword, along with three golden apples with which it can quickly recover from fights."
                }, new Ability[0]);
