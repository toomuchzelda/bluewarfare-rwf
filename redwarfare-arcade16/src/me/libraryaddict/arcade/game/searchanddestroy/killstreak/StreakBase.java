...
public abstract class StreakBase implements Listener {
    ...
    public void dropKillstreak(Player player, Location loc) {
        FallingBlock block = loc.getWorld().spawnFallingBlock(loc, getFallingMaterial().createBlockData());
    ...
    public void onItemUse(PlayerInteractEvent event) {
        ...
        boolean type = item.getType() == getItem().getType() && item.getType() != Material.ACACIA_LOG;
