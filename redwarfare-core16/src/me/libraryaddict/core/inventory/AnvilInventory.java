...
public abstract class AnvilInventory extends BasicInventory {
    ...
    public AnvilInventory(Player player, String title) {
        super(player, title);
        // TODO Auto-generated constructor stub
    }
    //commented out because only used by build server and im lazy
	/*
    ...
    private class FakeAnvil extends ContainerAnvil {
        ...
        public void a(String origString) {
            ...
            net.minecraft.server.v1_16_R3.ItemStack itemstack = getSlot(2).getItem();
