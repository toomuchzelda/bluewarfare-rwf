...
public class WorldData {
    ...
    public Block parseBlock(String string) {
        ...
        Block b = _world.getBlockAt(Integer.parseInt(split[0]), Integer.parseInt(split[1]), Integer.parseInt(split[2]));
        //    System.out.println(b.toString() + "," + b.getX() + "," + b.getY() + "," + b.getZ());
        return b;
    }
