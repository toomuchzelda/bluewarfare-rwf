...
//         * register(Material.SAPLING, 1, "Spruce Sapling"); register(Material.SAPLING,
//         * 2, "Birch Sapling"); register(Material.SAPLING, 3, "Jungle Sapling");
//         * register(Material.SAPLING, 4, "Acacia Sapling"); register(Material.SAPLING,
//         * 5, "Dark Oak Sapling");
//         *
//         * registerDura(Material.SAPLING, 0, "Oak"); registerDura(Material.SAPLING, 1,
//         * "Spruce"); registerDura(Material.SAPLING, 2, "Birch");
//         * registerDura(Material.SAPLING, 3, "Jungle"); registerDura(Material.SAPLING,
//         * 4, "Acacia"); registerDura(Material.SAPLING, 5, "DarkOak", "DOak");
//         */
//
...
//
//        /*
//         * register(Material.LOG, 0, "Oak Log", "Log"); register(Material.LOG, 1,
//         * "Spruce Log"); register(Material.LOG, 2, "Birch Log"); register(Material.LOG,
//         * 3, "Jungle Log");
//         *
//         * registerDura(Material.LOG, 0, "Oak"); registerDura(Material.LOG, 1,
//         * "Spruce"); registerDura(Material.LOG, 2, "Birch"); registerDura(Material.LOG,
//         * 3, "Jungle");
//         *
//         * register(Material.LOG_2, 0, "Acacia Log"); register(Material.LOG_2, 1,
//         * "Dark Oak Log");
//         *
//         * registerDura(Material.LOG_2, 0, "Acacia"); registerDura(Material.LOG_2, 1,
//         * "DarkOak", "DOak");
//         *
//         * register(Material.LEAVES, 0, "Oak Leaves", "Leaves");
//         * register(Material.LEAVES, 1, "Spruce Leaves"); register(Material.LEAVES, 2,
//         * "Birch Leaves"); register(Material.LEAVES, 3, "Jungle Leaves");
//         *
//         * registerDura(Material.LEAVES, 0, "Oak"); registerDura(Material.LEAVES, 1,
//         * "Spruce"); registerDura(Material.LEAVES, 2, "Birch");
//         * registerDura(Material.LEAVES, 3, "Jungle");
//         *
//         * register(Material.LEAVES_2, 0, "Acacia Leaves"); register(Material.LEAVES_2,
//         * 1, "Dark Oak Leaves");
//         *
//         * registerDura(Material.LEAVES_2, 0, "Acacia"); registerDura(Material.LEAVES_2,
//         * 1, "DarkOak", "DOak");
//         */
//
...
//
//        register(Material.FARMLAND, "Farmland", "Soil", "Tilled Dirt");
//
...
//
//        register(Material.INK_SAC, 0, "Ink Sac", "Black Dye", "Dye");
...
//
//        register(Material.PORKCHOP, 0, "Raw Pork");
//        register(Material.COOKED_PORKCHOP, 0, "Cooked Pork", "Grilled Pork", "Pork");
...
//    }
    ...
    public static List<String> getCompletions(String name, boolean blockOnly) {
        final String lowerCaseName = name.toLowerCase(Locale.ROOT);
        return Arrays.stream(Material.values())
                .filter(material -> !blockOnly || material.isBlock())
                .map(Material::name)
                .map(String::toLowerCase)
                .filter(itemName -> itemName.startsWith(lowerCaseName))
...
//        return null;
    ...
    public static String getName(Material mat) {
        return getName(new ItemStack(mat));
    }
    ...
    private static String getProperName(Material mat) {
        return StringUtils.capitalize(mat.name());
//
